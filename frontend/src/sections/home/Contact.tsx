  ...
  return (
    ...
    >
      <div className="max-w-xl mx-auto space-y-6">
        ...
        <p className="text-base text-slate/85 dark:text-gray-300 font-sans">
          Interested in collaborating or hiring? I’d love to hear from you.
        </p>

        <Link
          to="/contact"
          className="inline-block px-6 py-2 text-sm font-medium bg-accent text-softwhite rounded-full border border-accent hover:bg-accentHover transition"
        >
          Contact Me
        </Link>
      </div>
