const categories = [
    ...
    },
    {
      ...
      items: [
        ...
        'My style is dark feminine with earth tones',
        'I’m obsessed with fragrances and layering scents',
        'I’m learning to rock climb (and kind of love it)',
      ],
    },
  ];
    ...
    return (
      <div className="text-left space-y-8">
        ...
        {categories.map((cat, idx) => (
          <div key={idx}>
            <h3 className="text-xl font-semibold underline underline-offset-4 mb-2">{cat.title}</h3>
